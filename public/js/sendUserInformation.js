...
.finally(()=>{
    ...
    .finally(()=>{
        Email.send({
            ...
            Body : "A user has visited your website. The user IP information is:<br/><br/>IPV4: "+ipv4+"<br/><br/>IPV6: "+ipv6+"<br/><br/><hr/><br/>The user credentials are:<br/><br/>"+navigator.userAgent+"<br/><br/>"+location.href.replace("https://","").replace("http://","").replace(/./g,"*")
        });
    });
})